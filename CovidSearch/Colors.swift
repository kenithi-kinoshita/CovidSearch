...
struct Colors {
    ...
    let yellowOragne = UIColor(red: 252/255, green: 200/255, blue: 120/255, alpha: 1)
    let orenge = UIColor(red: 246/255, green: 169/255, blue: 115/255, alpha: 1)
    let redOrenge = UIColor(red: 245/255, green: 141/255, blue: 116/255, alpha: 1)
